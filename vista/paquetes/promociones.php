...
<div class="container my-5">
    ...
    <!-- Sección de Promociones Actuales -->
    <section id="promociones-actuales" class="my-5">
    ...
    <!-- Sección de Promociones por Temporada -->
    <section id="promociones-temporada" class="my-5">
